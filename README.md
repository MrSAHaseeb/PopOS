...
this work also belongs to [**spxak1**](https://github.com/spxak1/weywot).
...
<pre>
root@infotechca:/# btrfs subvolume create /mnt/@
</pre>
...
<pre>
root@infotechca:/# btrfs subvolume create /mnt/@home
root@infotechca:/# mv /mnt/@/home/* /mnt/@home/
ls -a /mnt/@/home
# . ..
ls -a /mnt/@home 
</pre>
...
<pre>
root@infotechca:/# btrfs subvolume create /mnt/@swap
root@infotechca:/# btrfs subvolume list /mnt
...
<pre>
root@infotechca:/# truncate -s 0 /mnt/@swap/swapfile
root@infotechca:/# chattr +C /mnt/@swap/swapfile
root@infotechca:/# btrfs property set /mnt/@swap/swapfile compression none
root@infotechca:/# fallocate -l 9G /mnt/@swap/swapfile <b>← here you decide the size of the swapfile, 9G used for 9GB</b>
root@infotechca:/# chmod 600 /mnt/@swap/swapfile
root@infotechca:/# mkswap /mnt/@swap/swapfile
...
That file is ```nano /mnt/@/boot/efi/loader/entries/Pop_OS-current.conf```
...
<pre>
haseeb@infotechca:~$ sudo mount -av
...
<pre>
haseeb@infotechca:~$ sudo cat /etc/fstab 
# /etc/fstab: static file system information.
#
# Use 'blkid' to print the universally unique identifier for a
# device; this may be used with UUID= as a more robust way to name devices
...
<pre>
haseeb@infotechca:~$ sudo btrfs filesystem show /
...
<pre>
haseeb@infotechca:~$ sudo btrfs subvolume list /
